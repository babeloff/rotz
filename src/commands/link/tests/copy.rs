//! Copy functionality tests for the rotz dotfile manager.
//!
//! This module contains tests for basic file copying operations and enhanced link creation
//! for non-encrypted link types (Copy, Internal, External, Record).
//!
//! # Test Categories
//!
//! ## Core Copy Functions
//! - `copyfile()` - Basic file and directory copying
//! - `copy_dir_all()` - Recursive directory copying with structure preservation
//!
//! ## Enhanced Link Creation
//! - `create_enhanced_link()` - Advanced link creation with bidirectional sync
//! - Configuration-driven link behavior for Internal/External/Record types
//! - Parent directory creation and overwrite handling
//!
//! ## Integration Tests
//! - Multi-type link system integration
//! - Configuration override behavior
//! - Type-specific sync direction testing
...
use super::super::{copy_dir_all, copyfile, create_enhanced_link, create_link};
